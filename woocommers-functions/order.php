        ...
        if ($customer_orders) {
            foreach ($customer_orders as $order) {
                ...
                foreach ($order->get_items() as $item_id => $item) {
                    ...
                    echo '        <div>';
                    echo '           <span class="font-medium block">Заказ №100132</span>';
                    echo '            <span class="text-lg font-bold">20 апреля</span>';
                    echo '        </div>';
                    echo '       <span class="text-xl font-bold">7 150 ₽</span>';
                    echo '    </div>';
                    echo '   <p class="text-dark-gray mb-5">7 товаров (0,7 кг)</p>';
                    echo '    <div class="flex flex-wrap gap-5 items-center justify-between">';
                    echo '       <ul class="flex gap-3">';
                    echo '            <li><img src="<?php echo get_template_directory_uri(); ?>/src/img/order-img.png"
                    ...
                    echo '            <li><img src="<?php echo get_template_directory_uri(); ?>/src/img/order-img.png"
                                        width="60" height="60" alt="img"></li>';
                    echo '         </ul>';
                    echo '       <button class="lk-order-item-button">';
